...
%
\begin{lstlisting}
https://github.com/Debolena/EE5609/blob/master/Assignment1/assignment1_python.py
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/Debolena/EE5609/blob/master/Assignment1/latex_code.tex
\end{lstlisting}
%
\section{Problem}
...
\begin{align}
    \vec{m} &= \vec{Q}-\vec{O}\\
    &=\label{eq:dv} \vec{Q}, \quad \because \vec{O} = \vec{0}
\end{align}
The direction vector can be expressed in terms of the slope as
\begin{equation}
    \label{eq:slope}\vec{m} = \myvec{1 \\ m}
\end{equation}

Now using (\ref{eq:midpoint}), (\ref{eq:dv}) and (\ref{eq:slope}),
\begin{align}
    \myvec{4\\-2}=\myvec{1\\m}\\
